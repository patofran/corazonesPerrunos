...
<body>
    ...
    <nav class="container text-center mt-5" id="papel">
        <h1 id="titulo">Aqui puedes ver todos nuestros commpañer@s esperando ansiosos a que los conozcas.</h1>
    </nav>
            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100 shadow-sm">
                    <a href="{{ url('/mascota/' . $mascota->idMascota) }}">
                        <img src="{{ $mascota->foto_mascotas }}" class="card-img-top" alt="Foto de {{ $mascota->nombre }}">
                    </a>
